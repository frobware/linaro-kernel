...
static HI_U32 cec_RX_MSG_Operation(HI_U8 Init, HI_U8 Dest, HI_U8 opcode, HI_U8 *pOperand, HI_U8 OperandLength, SiI_CEC_t *pCECframe)
{
    ...
    case CEC_OPCODE_CEC_VERSION:                     //0X9E
        ...
        HI_CEC_HDMI("OperandLength:0x%02x \n",OperandLength);
        switch (pOperand[0])
        {
            case 0x04 :
                HI_CEC_HDMI("Version 1.3a\n");
                break;
            case 0x05 :
                HI_CEC_HDMI("Version 1.4 or Version 1.4a or Version 1.4b \n");
                break;
            default:
                HI_CEC_HDMI("unknown CEC_VERSION \n");
        }
    ...
    case CEC_OPCODE_GIVE_OSD_NAME:                   //0X46
        HI_CEC_HDMI("CEC_OPCODE_GIVE_OSD_NAME, Response\n");
...
void store_cec_msg(SiI_CEC_t *rx_cmd)
{
    ...
    HI_CEC_HDMI("store_cec_msg num:%d  \n",can_read_num);
}
