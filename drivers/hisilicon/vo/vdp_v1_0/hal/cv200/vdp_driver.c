...
HI_VOID VDP_VID_SetRegionEnable(HI_U32 u32Data, HI_U32 u32Num, HI_U32 u32bEnable )
{
    ...
    else
    {
        ...
        if ( VDP_RM_LAYER_VID4 == u32Data )
            VDP_VID_Layer4LinkToMix2(HI_FALSE);
    }
...
HI_VOID VDP_DATE_SetDACDET(DISP_VENC_E enDate,HI_U32 u32DetLine,HI_U32 u32DetPixelSta)
{
    ...
    DHD0_VGA_DACDET1.bits.vdac_det_high =0x3FF ;
    DHD0_VGA_DACDET2.bits.det_pixel_wid = 100;

    if( DISP_VENC_HDATE0 == enDate)
    {
        HDATE_DACDET1.bits.det_line = u32DetLine ;
        HDATE_DACDET2.bits.det_pixel_sta= u32DetPixelSta;
        VDP_RegWrite((HI_U32)&(pVdpReg->HDATE_DACDET1.u32), HDATE_DACDET1.u32);
        VDP_RegWrite((HI_U32)&(pVdpReg->HDATE_DACDET2.u32), HDATE_DACDET2.u32);
    }
    else if (DISP_VENC_SDATE0 == enDate)
    {
        DATE_DACDET1.bits.det_line = u32DetLine ;
        DATE_DACDET2.bits.det_pixel_sta= u32DetPixelSta;
        VDP_RegWrite((HI_U32)&(pVdpReg->DATE_DACDET1.u32), DATE_DACDET1.u32);
        VDP_RegWrite((HI_U32)&(pVdpReg->DATE_DACDET2.u32), DATE_DACDET2.u32);
    }
    else if (DISP_VENC_VGA0 == enDate)
    {
        DHD0_VGA_DACDET1.bits.det_line = u32DetLine ;
        DHD0_VGA_DACDET2.bits.det_pixel_sta= u32DetPixelSta;

        VDP_RegWrite((HI_U32)&(pVdpReg->DHD0_VGA_DACDET1.u32), DHD0_VGA_DACDET1.u32);
        VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_VGA_DACDET1.u32)+CHN_OFFSET), DHD0_VGA_DACDET1.u32);
        //DHD0 and DHD1 open and close must at sample time
        //DHD0
        VDP_RegWrite((HI_U32)&(pVdpReg->DHD0_VGA_DACDET2.u32), DHD0_VGA_DACDET2.u32);
        //DHD1
        VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_VGA_DACDET2.u32)+CHN_OFFSET), DHD0_VGA_DACDET2.u32);
    }
    else  //do nothing
    {
    }
...
HI_VOID VDP_DATE_SetDACDetEn(DISP_VENC_E enDate, HI_U32 enable)
{
    ...
    HDATE_DACDET2.u32 =  VDP_RegRead((HI_U32)&(pVdpReg->HDATE_DACDET2.u32));
    DATE_DACDET2.u32  =  VDP_RegRead((HI_U32)&(pVdpReg->DATE_DACDET2.u32));
    DHD0_VGA_DACDET2.u32  =  VDP_RegRead((HI_U32)&(pVdpReg->DHD0_VGA_DACDET2.u32));
...
/*0x1, 0x00808080, 0x00808080,0x00010000*/
...
HI_VOID VDP_DATE_ResetFmt(DISP_VENC_E eDate, HI_DRV_DISP_FMT_E enFmt)
{
    ...
    if (DISP_VENC_SDATE0 == eDate)
    {
        ...
        /*zkun_confirm:*/
        VDP_DATE_SetSrcCoef(eDate, u32aSDDATESrcCoef[0]);
...
#if defined (CHIP_TYPE_hi3719mv100_a)
#define VDAC_CTRL_ENBG_AND_TRIM_RESET_VALUE1  0x92000000ul
#else
...
HI_VOID VDP_VDAC_ResetFmt(DISP_VENC_E enVenc ,HI_U32 uVdac, HI_DRV_DISP_FMT_E enFmt,HI_U32 u32CustomPixClk)
{
    ...
    */
     if (enVenc == DISP_VENC_VGA0)
    {
         ...
         VO_DAC_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->VO_DAC_CTRL.u32)));
         VO_DAC_CTRL.bits.mode_bg = VDECX_MODE_VGA;
         VDP_RegWrite((HI_U32)(&(pVdpReg->VO_DAC_CTRL.u32)), VO_DAC_CTRL.u32);
         vdacvalue = VDP_GetVGADacReviseValue(enFmt,u32CustomPixClk);
    }
    else
    {
        /*lcd format*/
         ...
         VO_DAC_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->VO_DAC_CTRL.u32)));
         VO_DAC_CTRL.bits.mode_bg = VDECX_MODE_TV;
         VDP_RegWrite((HI_U32)(&(pVdpReg->VO_DAC_CTRL.u32)), VO_DAC_CTRL.u32);
    }
...
HI_VOID VDP_VDAC_ResetFmt(DISP_VENC_E enVenc ,HI_U32 uVdac, HI_DRV_DISP_FMT_E enFmt,HI_U32 u32CustomPixClk)
{
    ...
    {
        case 3:
            VDP_RegWrite((HI_U32)(&(pVdpReg->VO_DAC_C_CTRL.u32)), 0x801f8000);
            break;

        case 0:
            //g_pstRegCrg->PERI_CRG71.u32 = g_pstRegCrg->PERI_CRG71.u32 | X5HD2_VDAC1_MASK_RESET;
            VDP_RegWrite((HI_U32)(&(pVdpReg->VO_DAC_R_CTRL.u32)), 0x801f8000);
            break;

        case 1:
            //g_pstRegCrg->PERI_CRG71.u32 = g_pstRegCrg->PERI_CRG71.u32 | X5HD2_VDAC2_MASK_RESET;
            VDP_RegWrite((HI_U32)(&(pVdpReg->VO_DAC_G_CTRL.u32)), 0x801f8000);

            break;
        case 2:
            //g_pstRegCrg->PERI_CRG71.u32 = g_pstRegCrg->PERI_CRG71.u32 | X5HD2_VDAC3_MASK_RESET;
            VDP_RegWrite((HI_U32)(&(pVdpReg->VO_DAC_B_CTRL.u32)), 0x801f8000);
