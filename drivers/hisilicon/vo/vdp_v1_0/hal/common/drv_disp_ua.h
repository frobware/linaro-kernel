...
typedef struct tagDISP_UA_FUNCTION_S
{
    ...
    HI_VOID (* pfUpdateAcmCoef)(PQ_ACM_COEF_S* pstPqAcmPara);
    HI_VOID (* pfSetAcmThdSet)(ALG_ACM_RTL_PARA_S* pstAcmRtlPara);  
    HI_VOID (* pfUpdateAccCoef)(PQ_ACC_COEF_S* pstPqAccPara);
    HI_VOID (* pfSetAccThdSet)(ALG_ACC_RTL_PARA_S* pstAccRtlPara);     
