...
HI_S32 DISP_GAMMA_Init(void)
{
    ...
    s32Ret = HI_DRV_MMZ_AllocAndMap("ALG_GMM_RGB", HI_NULL, (39 * 32) * 4, 0, (MMZ_BUFFER_S*)pstMBufRGB); //22*3*16  four table
    ...
    s32Ret = HI_DRV_MMZ_AllocAndMap("ALG_GMM_YUV", HI_NULL, (39 * 32) * 4, 0, (MMZ_BUFFER_S*)pstMBufYUV);
    if (s32Ret != HI_SUCCESS)
    {
