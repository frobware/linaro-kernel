...
static HI_S32 HAL_WbcCscFunc(DISP_WBC_E eWbc,
                            ALG_CSC_DRV_PARA_S *pstCscI,
                            ALG_CSC_RTL_PARA_S *pstCscO)
{
    return Chip_Specific_WbcCscFunc(eWbc, pstCscI, pstCscO);
}
#endif
    ...
    */
    ...
    if (pstCfg->stInfo.eDispMode == DISP_STEREO_FPK)
    {
       ...
       | VFB0 || VBB0 |     VACT0     | VFB0 || VBB01 |     VACT1    | VFB1 ||
            ...
            */
        thd = (pstCfg->stTiming.u32Vfb + pstCfg->stTiming.u32Vbb)*2 + 
                pstCfg->stTiming.u32Vact + DISP_VTTHD_GFX_OFFSET;
    ...
    else
    {
        ...
        */
        ...
        {
            thd = thd + DISP_VTTHD_DISP0_TO_DISP1;
    		if (thd >= (pstCfg->stTiming.u32Vbb + pstCfg->stTiming.u32Vfb +  pstCfg->stTiming.u32Vact))
    		{
    		    thd = pstCfg->stTiming.u32Vbb + pstCfg->stTiming.u32Vfb +  pstCfg->stTiming.u32Vact - 1;
    		}
        }
...
{
#ifndef __DISP_PLATFORM_BOOT__
    ALG_CSC_DRV_PARA_S stCscI;
    ALG_CSC_RTL_PARA_S stCscO;
    VDP_CSC_DC_COEF_S stDcCoef;
    VDP_CSC_COEF_S stCoef;

    memset(&stCscI,0x0,sizeof(ALG_CSC_DRV_PARA_S));
    memset(&stCscO,0x0,sizeof(ALG_CSC_RTL_PARA_S));
    memset(&stDcCoef,0x0,sizeof(VDP_CSC_DC_COEF_S));
    memset(&stCoef,0x0,sizeof(VDP_CSC_COEF_S));

    stCscI.eInputCS = eSrcCS;
    stCscI.eOutputCS = eDstCS;
    stCscI.bIsBGRIn = HI_FALSE;
    stCscI.u32Bright = 50;
    stCscI.u32Contrst = 50;
    stCscI.u32Hue = 50;
    stCscI.u32Satur = 50;
    stCscI.u32Kb = 50;
    stCscI.u32Kr = 50;
    stCscI.u32Kg = 50;
    HAL_WbcCscFunc(eWbc,&stCscI,&stCscO);
    if (eSrcCS == eDstCS)
    {
    ...
    {
        stDcCoef.csc_in_dc0 = stCscO.s32CscDcIn_0/4;
        stDcCoef.csc_in_dc1 = stCscO.s32CscDcIn_1/4;
        stDcCoef.csc_in_dc2 = stCscO.s32CscDcIn_2/4;
        stDcCoef.csc_out_dc0 = stCscO.s32CscDcOut_0/4;
        stDcCoef.csc_out_dc1 = stCscO.s32CscDcOut_1/4;
        stDcCoef.csc_out_dc2 = stCscO.s32CscDcOut_2/4;
        VDP_WBC_SetCscDcCoef(s_eWbcHalID[eWbc], stDcCoef);
        stCoef.csc_coef00 = stCscO.s32CscCoef_00;
        stCoef.csc_coef01 = stCscO.s32CscCoef_01;
        stCoef.csc_coef02 = stCscO.s32CscCoef_02;
        stCoef.csc_coef10 = stCscO.s32CscCoef_10;
        stCoef.csc_coef11 = stCscO.s32CscCoef_11;
        stCoef.csc_coef12 = stCscO.s32CscCoef_12;
        stCoef.csc_coef20 = stCscO.s32CscCoef_20;
        stCoef.csc_coef21 = stCscO.s32CscCoef_21;
        stCoef.csc_coef22 = stCscO.s32CscCoef_22;
...
HI_S32 PF_DATE_SetCoef(HI_DRV_DISPLAY_E enDisp, HI_S32 u32Index)
{
    ...
    VDP_DATE_SetSrcCoef(DISP_VENC_SDATE0, u32aSDDATESrcCoef[u32Index]);
...
HI_S32 DISP_HAL_Init(HI_U32 u32Base)
{
    ...
    g_stVDACAttr.bDACDetEn = HI_TRUE;
