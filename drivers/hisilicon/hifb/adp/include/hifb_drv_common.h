...
#define CFG_HIFB_COMPRESSION_ENABLE
#endif
...
#define IS_HD_LAYER(enLayerId) (HIFB_LAYER_HD_1 > enLayerId)
#define IS_SD_LAYER(enLayerId) ((enLayerId >= HIFB_LAYER_SD_0) && (HIFB_LAYER_SD_1 > enLayerId))
#define IS_AD_LAYER(enLayerId) ((enLayerId >= HIFB_LAYER_AD_0) && (HIFB_LAYER_AD_3 >= enLayerId))
#define IS_MINOR_HD_LAYER(enLayerId) ((HIFB_LAYER_HD_3 >= enLayerId) && (enLayerId >= HIFB_LAYER_HD_1))
#define IS_MINOR_SD_LAYER(enLayerId) ((HIFB_LAYER_SD_3 >= enLayerId) && (enLayerId >= HIFB_LAYER_SD_1))
