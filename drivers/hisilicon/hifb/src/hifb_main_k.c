...
#define HD_LOGO_LAYE_ADDR 0xf8cc7000
...
HI_S32 hifb_init_module_k(HI_VOID)
{
    ...
    g_u32HDLogoCtrlReg = (HI_U32*)ioremap_nocache(HD_LOGO_LAYE_ADDR, 8);
	g_u32SDLogoCtrlReg = (HI_U32*)ioremap_nocache(SD_LOGO_LAYE_ADDR, 8);
