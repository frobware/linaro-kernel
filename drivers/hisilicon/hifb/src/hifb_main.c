...
#define HIFB_HD_LOGO_LAYER_ID HIFB_LAYER_HD_2
...
static HI_S32 hifb_3DData_Config(HIFB_LAYER_ID_E enLayerId, HIFB_BUFFER_S *pstBuffer, HIFB_BLIT_OPT_S *pstBlitOpt)
{
	...
	//		pstBuffer->stCanvas.u32PhyAddr,pstBuffer->stCanvas.u32Width,pstBuffer->stCanvas.u32Height,
	//		pstBuffer->stCanvas.u32Pitch,pstBuffer->stCanvas.enFmt);
...
#ifdef CFG_HIFB_COMPRESSION_ENABLE	
...
#ifdef CFG_HIFB_LOGO_SUPPORT		
	hifb_clear_logo(par->stBaseInfo.u32LayerID);
#endif	
