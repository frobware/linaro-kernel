...
#define CMD_AO_SND_SETALLTRACKMUTE _IOW  (HI_ID_AO, 0x23, AO_SND_AllTrackMute_Param_S)
#define CMD_AO_SND_GETALLTRACKMUTE _IOWR	(HI_ID_AO, 0x24, AO_SND_AllTrackMute_Param_S)
