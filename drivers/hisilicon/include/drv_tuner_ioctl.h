...
#define TUNER_SET_COMMONPLP_CMD _IOW(HI_TUNER_IOC_MAGIC, 39, TUNER_DATA_S)
#define TUNER_SET_COMMONPLP_COMBINATION_CMD _IOW(HI_TUNER_IOC_MAGIC, 40, TUNER_DATA_S)
#define TUNER_GET_PLP_ID_CMD _IOWR(HI_TUNER_IOC_MAGIC, 41, TUNER_DATA_S)
#define TUNER_GET_GROUP_PLP_ID_CMD _IOWR(HI_TUNER_IOC_MAGIC, 42, TUNER_DATA_S)
#define TUNER_SET_ANTENNA_POWER_CMD _IOW(HI_TUNER_IOC_MAGIC, 43, TUNER_DATA_S)
#define TUNER_TERSCAN_ACTION_CMD _IOWR(HI_TUNER_IOC_MAGIC, 44, TUNER_TERSCAN_INFO_S)
/*
