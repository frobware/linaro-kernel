...
HI_S32 TRACK_SetAbsGain(SND_CARD_STATE_S *pCard, HI_U32 u32TrackID, HI_UNF_SND_ABSGAIN_ATTR_S *pstTrackAbsGain)
{
    ...
    {
        CHECK_AO_ABSLUTEVOLUME(pstTrackAbsGain->s32GainL);
        CHECK_AO_ABSLUTEVOLUME(pstTrackAbsGain->s32GainR);
...
HI_S32 TRACK_SetPcmAttr(SND_CARD_STATE_S *pCard, HI_U32 u32TrackID, AIAO_RBUF_ATTR_S* pstAiaoBuf, HI_UNF_AI_ATTR_S *pstAiAttr)
{
    SND_TRACK_STATE_S *pTrack;
    AOE_AIP_CHN_ATTR_S stAipAttr;
    ...
    stAipAttr.stBufInAttr.u32BufSampleRate = (HI_U32)(pstAiAttr->enSampleRate);
    stAipAttr.stBufInAttr.u32BufBitPerSample = (HI_U32)(pstAiAttr->unAttr.stI2sAttr.stAttr.enBitDepth);
    stAipAttr.stBufInAttr.u32BufChannels = (HI_U32)(pstAiAttr->unAttr.stI2sAttr.stAttr.enChannel);
    
    stAipAttr.stBufInAttr.stRbfAttr.u32BufPhyAddr = pstAiaoBuf->u32BufPhyAddr;
    stAipAttr.stBufInAttr.stRbfAttr.u32BufPhyRptr = pstAiaoBuf->u32BufPhyRptr;
    stAipAttr.stBufInAttr.stRbfAttr.u32BufPhyWptr = pstAiaoBuf->u32BufPhyWptr;
    stAipAttr.stBufInAttr.stRbfAttr.u32BufVirAddr = pstAiaoBuf->u32BufVirAddr;
    stAipAttr.stBufInAttr.stRbfAttr.u32BufVirRptr = pstAiaoBuf->u32BufVirRptr;
    stAipAttr.stBufInAttr.stRbfAttr.u32BufVirWptr = pstAiaoBuf->u32BufVirWptr;
    stAipAttr.stBufInAttr.stRbfAttr.u32BufSize = pstAiaoBuf->u32BufSize;
