...
#define DBG_CMD_TRACE         "set_TraceOption"
#define DBG_CMD_PATH          "set_SavePath"
#define DBG_CMD_NAME          "set_SaveName"
#define DBG_CMD_STRMCTRL      "set_StreamCtrl"
#define DBG_CMD_LOWBUF        "set_LowBuf"
#define DBG_CMD_DEI           "set_Dei"
#define DBG_CMD_DISPNUM       "set_DispNum"
#define DBG_CMD_SEGSIZE       "set_SegSize"
#define DBG_CMD_INBUFTHRED    "set_InBufThred"
...
struct chan_ctx_s {
    ...
    HI_U32     HeaderLen;
    HI_CHAR    HeaderBuf[HEADER_BUFFER_SIZE];
	...
	HI_U32 u32MaxInBufNum;
	HI_U32 u32MaxOutBufNum;
	HI_VOID *pInputBufTable;
	HI_VOID *pOutputBufTable;
    MMZ_BUFFER_S stBufTable;
    ...
    HI_U32 last_frame_vpss_got;
    HI_U32 last_frame_info[2];     /* 0 (0/1): vfmw 是否上报; 
