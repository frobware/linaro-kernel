...
{
    {432000, 1130, 0x161}, {400000, 1090, 0x146}, {375000, 1060, 0x141}, {345600, 1030, 0x120},
    {300000, 1000, 0x110}, {250000, 1000, 0x110}, {200000, 1000, 0x110}, {150000, 1000, 0x110}
};
#elif defined(CHIP_TYPE_hi3718mv100)
GPU_VF_S gpu_freq_volt_table[MAX_FREQ_NUM] =
{
    {432000, 1190, 0x188}, {400000, 1140, 0x150}, {375000, 1120, 0x147}, {345600, 1080, 0x120},
    {300000, 1020, 0x110}, {250000, 1000, 0x110}, {200000, 1000, 0x110}, {150000, 1000, 0x110}
};
#else
GPU_VF_S gpu_freq_volt_table[MAX_FREQ_NUM] =
{
...
#elif defined (CHIP_TYPE_hi3719mv100_a) || defined (CHIP_TYPE_hi3719mv100) || defined (CHIP_TYPE_hi3718mv100)
