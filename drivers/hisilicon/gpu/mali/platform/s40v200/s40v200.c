...
/*under the dangle mode*/
    ...
    {
        MALI_GPU_RESOURCES_MALI400_MPX_PMU(MALI_BASE_ADDRESS, GP_IRQ,  GP_MMU_IRQ,	PP0_IRQ, PP0_MMU_IRQ, PP1_IRQ,
                                           PP1_MMU_IRQ,       PP2_IRQ, PP2_MMU_IRQ, PP3_IRQ, PP3_MMU_IRQ)
    };
    ...
    err = platform_device_add_resources(&mali_gpu_device, mali_gpu_resources_m400_mpx, \
                                        (sizeof(mali_gpu_resources_m400_mpx) / sizeof(mali_gpu_resources_m400_mpx[0])
                                         - (4 - num_pp_cores) * 4));
    if (0 == err)
    {
