...
typedef struct
{
    ...
    ALG_ZME_FORMAT_E enZmeYCFmtIn;     /*video format for zme input: 0-422; 1-420; 2-444*/
    ALG_ZME_FORMAT_E enZmeYCFmtOut;    /*video format for zme Output: 0-422; 1-420; 2-444*/
...
HI_VOID VZmeLoadVpssCoefHV(HI_U32 *pu32CurAddr,HI_U32 u32PhyAddr,ALG_VZME_COEF_ADDR_S *pstAddrTmp);

HI_S32 GetVerticalScalerOffset(HI_U32 u32VRatio, ALG_VZME_DRV_PARA_S *pstZmeDrvPara);
HI_U32 GetHLfirCoef(ALG_VZME_COEF_ADDR_S *pstCoefAddr, HI_U32 u32Ratio);
HI_U32 GetHCfirCoef(ALG_VZME_COEF_ADDR_S *pstCoefAddr, HI_U32 u32Ratio);
HI_U32 GetVLfirCoef(ALG_VZME_COEF_ADDR_S *pstCoefAddr, HI_U32 u32Ratio);
HI_U32 GetVCfirCoef(ALG_VZME_COEF_ADDR_S *pstCoefAddr, HI_U32 u32Ratio);

HI_S32 ALG_VZmeComnSet(ALG_VZME_DRV_PARA_S *pstZmeDrvPara, ALG_VZME_RTL_PARA_S *pstZmeRtlPara);
