...
HI_S32 VPSS_OSAL_CalBufSize(HI_U32 *pSize,HI_U32 *pStride,HI_U32 u32Height,HI_U32 u32Width,HI_DRV_PIX_FORMAT_E ePixFormat)
{
    HI_U32 u32RetSize = 0;
    ...
    switch (ePixFormat)
    {
        ...
        case HI_DRV_PIX_FMT_ABGR8888:
            u32RetStride = (u32Width*4 + 0xf) & 0xfffffff0;
