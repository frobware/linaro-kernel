				       ...
				       struct drm_display_mode *adjusted_mode)
{
	...
	} else if(!strcmp(adjusted_mode->name,"1920x1080i")){
		hix5hd2_write_bits(hdev, HDATE_VIDEO_FORMAT, VIDEO_FT_START, VIDEO_FT_LEN, VIDEO_FT_1080I);
	} else if(!strcmp(adjusted_mode->name,"1920x1080")){
...
struct hix5hd2_drm_display_ops hix5hd2_component_ops = {
...
struct hix5hd2_drm_display hix5hd2_component= {
	.list = LIST_HEAD_INIT(hix5hd2_component.list),
	.type = HIX5HD2_DISPLAY_COMPONENT,
	.ops = &hix5hd2_component_ops,
};
